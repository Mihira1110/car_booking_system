...
exports.getDailyBookingsReport = async (req, res) => {
    try {
        const startDate = new Date(req.query.startDate); // Expecting a start date in query
        const endDate = new Date(req.query.endDate); // Expecting an end date in query
        
        // Aggregate bookings count by day
...
exports.getTotalRevenueReport = async (req, res) => {
    try {
